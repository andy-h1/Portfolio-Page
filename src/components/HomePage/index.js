...
export const HomePage = () => (
        <S.FlexWrapper>
                <S.GridWrapper>
                        ...
                        <S.Text>
                                Hey! Welcome to my website that I've built in React. Currently I am working as a tech
                        ...
                        <S.Text>
                                ...
                                lies. My end goal is to build something useful for the healthcare sector but in the
                                meantime I'm honing my skills in everything front-end.
                        </S.Text>
                </S.GridWrapper>
                <ProjectList />
        </S.FlexWrapper>
